...
const DoYouHaveAnyCertificates = ({handleFormShown,isYes,setIsYes,prevStep}) => {
    return (
        
            <form onSubmit={handleFormShown} className="space-y-4 w-full">
                <div className="flex flex-col gap-2.5 w-full">
                <Label className="font-semibold">Do you have any certifications that can we can add to your resume ?</Label>
                <RadioGroup onValueChange={(value) => setIsYes(value === "true")} value={isYes?.toString()}>
                    ...
                    <div className="flex items-center space-x-2 ">
                        <RadioGroupItem className={"hover:bg-blue-500 hover:ring-2  hover:ring-black "} value="true" id="yes" />
                        <Label htmlFor="yes">Yes</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem className={"hover:bg-blue-500 hover:ring-2  hover:ring-black"} value="false" id="no" />
