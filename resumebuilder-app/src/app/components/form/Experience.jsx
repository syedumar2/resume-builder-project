...
const createExperienceSchema = (count) => {
    return z.object({
        experiences: z.array(singleExperienceSchema).length(count, `Exactly ${count} experiences required`),
    });
};
...
// control	Used when working with controlled components (e.g., Controller from RHF).
    ...
    return(
        <div className="flex flex-col gap-2">
            ...
            {!showForm ? (<DoYouHaveAnyExp handleCountSubmit={handleCountSubmit} prevStep={prevStep} />):
            (
